#ifndef GNG_NETWORK_H
#define GNG_NETWORK_H
...
public:
    ...
    //Create the kernels
    void createKernels(cl::Context &context, cl::Program &program);
...
private:
    ...
    cl::Kernel findTwoNeraestNodeKernel;
    cl::Kernel iterate_step1_Kernel;
    cl::Kernel iterate_step2_Kernel;
    cl::Kernel iterate_step3_addEdge_Kernel;
    cl::Kernel iterate_step3_addNode_Kernel;
    cl::Kernel iterate_step4_Kernel;
    cl::Kernel iterate_step5_Kernel;
    cl::Kernel iterate_step6_Kernel;
};
#endif